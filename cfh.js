...
// Update headers based on curl response
//headers["date"] = "Mon, 20 Nov 2023 23:53:57 GMT";
headers["content-type"] = "text/html; charset=UTF-8";
headers["vary"] = "Accept-Encoding";
headers["cache-control"] = "no-cache, private";
headers["set-cookie"] = "laravel_session=eyJpdiI6IlhTNzZsd...; path=/; httponly";
headers["set-cookie"] += ", SRVNAME=111; path=/";
headers["age"] = "0";
headers["x-cache"] = "MISS";
headers["x-cache-hits"] = "0";
headers["cf-cache-status"] = "DYNAMIC";
headers["server"] = "cloudflare";
headers["cf-ray"] = "82949d8239215ce2-SIN";
